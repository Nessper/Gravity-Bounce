...
public class RunConfig : MonoBehaviour
{
    ...
    /// <summary>
    /// Identifiant du monde sélectionné pour la run actuelle.
    /// Pour l'instant, c'est une progression linéaire (W1, W2, etc.).
    /// La structure réelle des niveaux vient de WorldCatalog.
    /// </summary>
    [Header("Progression / Monde")]
    public string SelectedWorldId = "W1";

    /// <summary>
    /// Index du niveau courant dans le monde sélectionné.
    /// 0 = premier niveau (ex: W1-L1 si c'est l'ordre du WorldCatalog).
    /// </summary>

...
public class BinFlushFX : MonoBehaviour
{
    ...
    {
        [Tooltip("Identifiant stable du tier (ex: 0, 1, 2, 3).")]
        public int tierId;
    ...
    public int ResolveTierId(bool hasBlackBall, int flushScore)
    {
        if (hasBlackBall)
            return -1;
        ...
        // Si aucune range ne match, on retombe sur 0 (faible)
        return 0;
    }
